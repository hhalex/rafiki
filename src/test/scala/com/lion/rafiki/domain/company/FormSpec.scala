...
"""
  ...
  val correctlyEncodedGroupUpdate = Form.Tree.GroupWithKey(Form.Tree.tag(2), Nil).asInstanceOf[Form.Tree].asJson.noSpaces should beEqualTo("""{"id":2,"children":[]}""")
  val correctlyEncodedQuestionUpdate = Form.Tree.QuestionWithKey(Form.Tree.tag(3), "label", "text", Nil).asInstanceOf[Form.Tree].asJson.noSpaces should beEqualTo(
    """{"id":3,"label":"label","text":"text","answers":[]}"""
  )
  val correctlyEncodedTextUpdate = Form.Tree.TextWithKey(Form.Tree.tag(4), "text").asInstanceOf[Form.Tree].asJson.noSpaces should beEqualTo("""{"id":4,"text":"text"}""")
  ...
  val correctlyDecodedGroupUpdate = jawn.decode[Form.Tree]("""{"id":2,"children":[]}""") should beRight(Form.Tree.GroupWithKey(Form.Tree.tag(2), Nil))
  val correctlyDecodedQuestionUpdate = jawn.decode[Form.Tree]("""{"id":3,"label":"label","text":"text","answers":[]}""") should beRight(Form.Tree.QuestionWithKey(Form.Tree.tag(3), "label", "text", Nil))
  val correctlyDecodedTextUpdate = jawn.decode[Form.Tree]("""{"id":4,"text":"text"}""") should beRight(Form.Tree.TextWithKey(Form.Tree.tag(4), "text"))
  ...
  val correctlyEncodedFreeTextWithIdAnswer = Form.Tree.Question.Answer.FreeTextWithId(Form.Tree.Question.Answer.tag(2), "label".some).asInstanceOf[Form.Tree.Question.Answer].asJson.noSpaces should beEqualTo("""{"id":2,"label":"label"}""")
  val correctlyEncodedNumericWithIdAnswer = Form.Tree.Question.Answer.NumericWithId(Form.Tree.Question.Answer.tag(2), None, 1).asInstanceOf[Form.Tree.Question.Answer].asJson.noSpaces should beEqualTo("""{"id":2,"label":null,"value":1}""")
  ...
  val correctlyDecodedFreeTextWithIdAnswer = jawn.decode[Form.Tree.Question.Answer]("""{"id":2,"label":"label"}""") should beRight(Form.Tree.Question.Answer.FreeTextWithId(Form.Tree.Question.Answer.tag(2), "label".some))
  val correctlyDecodedNumericWithIdAnswer = jawn.decode[Form.Tree.Question.Answer]("""{"id":2,"value":1}""") should beRight(Form.Tree.Question.Answer.NumericWithId(Form.Tree.Question.Answer.tag(2), None, 1))
  ...
  val correctlyDecodeFormCreate = jawn.decode[Form.Create](
    ...
    Form.Tree.Group(List(
      Form.Tree.Question("q-000", "Q1", List(
        Form.Tree.Question.Answer.NumericWithId(Form.Tree.Question.Answer.tag(2), "num_value1".some, 1),
        Form.Tree.Question.Answer.NumericWithId(Form.Tree.Question.Answer.tag(3), "num_value2".some, 2))
      ),
      Form.Tree.Question("q-001", "Q2", List(
        Form.Tree.Question.Answer.NumericWithId(Form.Tree.Question.Answer.tag(2), None, 1),
        Form.Tree.Question.Answer.FreeTextWithId(Form.Tree.Question.Answer.tag(3), "freetext".some))
      )
    )).some)
  )
}
